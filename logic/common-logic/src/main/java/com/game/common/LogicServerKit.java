...
import com.game.common.process.hook.MyRequestMessageClientProcessorHook;
...
//
        // 使用自定义 FlowContext
        builder.setFlowContextFactory(FlowContextEx::new);
        ...
        // cmd 最大范围
        setting.setCmdMaxLen(100000);
        setting.setSubCmdMaxLen(100000);
        // 打印设置
        setting.setPrintHandler(true);
        setting.setPrintInout(true);
        setting.setPrintDataCodec(true);
        setting.setPrintAction(true);
        setting.setPrintActionShort(true);
